...
- `--ignore` is used to work with "unstable" or "unmaintained" releases (see
  {ref}`here<chisel_yaml_format_spec_maintenance>`). The valid values are
  "unstable" or "unmaintained" respectively.
